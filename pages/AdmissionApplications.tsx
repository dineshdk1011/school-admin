...
import { MOCK_ADMISSION_APPLICATIONS, STATUS_OPTIONS } from '../constants';
...
const AdmissionApplications: React.FC = () => {
  const [applications, setApplications] = useState<AdmissionApplication[]>(MOCK_ADMISSION_APPLICATIONS);
